...
class Solver(ParallelManager):
    def __init__(self, n, dt, lbfreq=10):
    ...
    def init_lb(self, lbfreq):
        ...
        self.lb.set_data(vx=self.vx, vy=self.vy)
    ...
    def check(self):
        ...
        vx = self.lb.lb_data.vx.get()#.reshape((self.n, self.n))
        vy = self.lb.lb_data.vy.get()#.reshape((self.n, self.n))
